...
The wrapper is not part of the openMHA project. The NAL NL2 DLL is not part of
the wrapper and needs to be purchased from the National Acoustic Laboratories independently.
